...
__(Um parênteses sobre interações)__

\footnotesize

```{r laringe.publish, echo=TRUE, message=FALSE, warning=FALSE}
...
- Modelos não aninhados podem ser comparados pelos \structure{critérios de informação de Akaike (AIC)} ou \structure{Bayesiano (BIC)}.
    + Ao comparar modelos ajustados por máxima verossimilhança para os mesmos dados, quanto menor o AIC (ou BIC), melhor é o ajuste.
...
- Existem diversas formas de introduzir efeitos não-lineares em modelos de regressão.
- As funções _spline_ são uma forma elegante e eficiente de incorporar não-linearidades nos modelos de regressão.
    + As funções _spline_ não são indicadas apenas para o modelo de Cox.
- Neste breve exemplo, vamos apenas considerar dois tipos de funções _spline_ e suas respectivas implementações em `R`:
    + \structure{P-splines};
    + \structure{Natural splines} (ou splines cúbicos restritos).
...
```{r laringe.sp2, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', out.width='90%'}
...
```{r laringe.sp3, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', out.width='90%'}
...
```{r laringe.sp4, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', out.width='90%'}
...
```{r laringe.sp5, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', out.width='90%'}
